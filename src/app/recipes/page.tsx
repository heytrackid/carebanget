    ...
    <Sidebar>
      <div className="max-w-7xl mx-auto py-6 px-4">
        ...
        <div className="mb-6 sm:mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Koleksi Resep</h1>
            <p className="text-gray-600 mt-1 text-sm sm:text-base">
              Jelajahi semua resep MPASI yang tersedia dalam katalog lengkap kami
            </p>
          </div>
        </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-green-900 mb-1">
                  Apa itu Koleksi Resep?
                </h3>
                <p className="text-sm text-green-800">
                  Ini adalah <strong>katalog lengkap</strong> semua resep MPASI yang tersedia. 
                  Anda bisa mencari, memfilter, dan melihat detail lengkap setiap resep. 
                  Cocok untuk menemukan ide resep baru atau melihat variasi menu.
                </p>
                <div className="mt-2 text-xs text-green-700">
                  💡 <strong>Ingin jadwal makan lengkap?</strong> Gunakan <em>Rencana Makan</em> untuk membuat schedule otomatis
                </div>
              </div>
            </div>
          </CardContent>
          ...
          <Card>
            <CardContent className="p-4">
              <div className="text-2xl font-bold text-red-600">
                {mockRecipes.filter(r => r.difficulty === 'hard').length}
              </div>
